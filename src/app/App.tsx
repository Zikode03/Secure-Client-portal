...
const AdminRolesPage = lazy(() =>
  import("../pages/admin/AdminRolesPage").then((module) => ({ default: module.AdminRolesPage })),
);
const AdminAuditPage = lazy(() =>
  import("../pages/admin/AdminAuditPage").then((module) => ({ default: module.AdminAuditPage })),
);
const AdminAccountantsPage = lazy(() =>
  import("../pages/admin/AdminAccountantsPage").then((module) => ({ default: module.AdminAccountantsPage })),
);
const AdminAssignmentsPage = lazy(() =>
  import("../pages/admin/AdminAssignmentsPage").then((module) => ({ default: module.AdminAssignmentsPage })),
);
...
const ClientDocumentsPage = lazy(() =>
  import("../pages/client/ClientDocumentsPage").then((module) => ({ default: module.ClientDocumentsPage })),
);
const ClientMonthlyPackWorkspacePage = lazy(() =>
  import("../pages/client/ClientMonthlyPackWorkspacePage").then((module) => ({ default: module.ClientMonthlyPackWorkspacePage })),
);
const ClientNotificationsPage = lazy(() =>
  import("../pages/client/ClientNotificationsPage").then((module) => ({ default: module.ClientNotificationsPage })),
);
const ClientRequestsPage = lazy(() =>
  import("../pages/client/ClientRequestsPage").then((module) => ({ default: module.ClientRequestsPage })),
);
const ClientSettingsPage = lazy(() =>
  import("../pages/client/ClientSettingsPage").then((module) => ({ default: module.ClientSettingsPage })),
);
...
const AccountantComplianceCentrePage = lazy(() =>
  import("../pages/accountant/AccountantComplianceCentrePage").then((module) => ({ default: module.AccountantComplianceCentrePage })),
);
const AccountantDashboardPage = lazy(() =>
  import("../pages/accountant/AccountantDashboardPage").then((module) => ({ default: module.AccountantDashboardPage })),
);
const AccountantDocumentsPage = lazy(() =>
  import("../pages/accountant/AccountantDocumentsPage").then((module) => ({ default: module.AccountantDocumentsPage })),
);
const AccountantFilingPage = lazy(() =>
  import("../pages/accountant/AccountantFilingPage").then((module) => ({ default: module.AccountantFilingPage })),
);
const AccountantNotificationsPage = lazy(() =>
  import("../pages/accountant/AccountantNotificationsPage").then((module) => ({ default: module.AccountantNotificationsPage })),
);
...
const FirmReviewQueuePage = lazy(() =>
  import("../pages/firm/FirmReviewQueuePage").then((module) => ({ default: module.FirmReviewQueuePage })),
);
...
const FirmRequestDetailPage = lazy(() =>
  import("../pages/firm/FirmRequestDetailPage").then((module) => ({ default: module.FirmRequestDetailPage })),
);
const FirmActivityFeedPage = lazy(() =>
  import("../pages/firm/FirmActivityFeedPage").then((module) => ({ default: module.FirmActivityFeedPage })),
);
const FirmComplianceCalendarPage = lazy(() =>
  import("../pages/firm/FirmComplianceCalendarPage").then((module) => ({ default: module.FirmComplianceCalendarPage })),
);
const FirmExceptionsQueuePage = lazy(() =>
  import("../pages/firm/FirmExceptionsQueuePage").then((module) => ({ default: module.FirmExceptionsQueuePage })),
);
const FirmClient360Page = lazy(() =>
  import("../pages/firm/FirmClient360Page").then((module) => ({ default: module.FirmClient360Page })),
);
const NotificationPreferencesPage = lazy(() =>
  import("../pages/shared/NotificationPreferencesPage").then((module) => ({ default: module.NotificationPreferencesPage })),
);
const AdminRequestStateMachinePage = lazy(() =>
  import("../pages/admin/AdminRequestStateMachinePage").then((module) => ({ default: module.AdminRequestStateMachinePage })),
);
const AccessDeniedPage = lazy(() =>
  import("../pages/shared/AccessDeniedPage").then((module) => ({ default: module.AccessDeniedPage })),
);
const ForgotPasswordPage = lazy(() =>
  import("../pages/shared/ForgotPasswordPage").then((module) => ({ default: module.ForgotPasswordPage })),
);
const InviteSetupPage = lazy(() =>
  import("../pages/shared/InviteSetupPage").then((module) => ({ default: module.InviteSetupPage })),
);
...
function redirectAdminPath(pathname: string) {
  if (pathname.startsWith("/admin/users")) return pathname.replace("/admin/users", "/firm/admin/users");
  if (pathname.startsWith("/admin/roles")) return pathname.replace("/admin/roles", "/firm/admin/roles");
  if (pathname.startsWith("/admin/audit")) return pathname.replace("/admin/audit", "/firm/admin/audit");
  if (pathname.startsWith("/admin/accountants")) return pathname.replace("/admin/accountants", "/firm/admin/accountants");
  if (pathname.startsWith("/admin/assignments")) return pathname.replace("/admin/assignments", "/firm/admin/assignments");
  if (pathname.startsWith("/admin/system-settings")) return pathname.replace("/admin/system-settings", "/firm/admin/system-settings");
  if (pathname.startsWith("/admin/request-state-machine")) return pathname.replace("/admin/request-state-machine", "/firm/admin/request-state-machine");
  if (pathname.startsWith("/admin/templates") || pathname.startsWith("/admin/deadlines") || pathname.startsWith("/admin/policies")) {
    return pathname.replace(/^\/admin(?:\/templates|\/deadlines|\/policies)/, "/firm/admin/system-settings");
  }
  if (pathname.startsWith("/admin/settings")) return pathname.replace("/admin/settings", "/firm/admin/system-settings");
    ...
    <Suspense fallback={<LoadingShell />}>
      <Routes>
        ...
        <Route element={<RequireClientWorkspace />} path="/client">
          ...
          <Route element={<ClientMonthlyPackWorkspacePage />} path="packs" />
        ...
        <Route element={<RequireFirmWorkspace />} path="/firm">
          ...
          <Route element={<RequirePermission permission="manage:roles"><AdminRolesPage /></RequirePermission>} path="admin/roles" />
          <Route element={<RequirePermission permission="manage:users"><AdminAccountantsPage /></RequirePermission>} path="admin/accountants" />
